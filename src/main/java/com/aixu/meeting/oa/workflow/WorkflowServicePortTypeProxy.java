...
public class WorkflowServicePortTypeProxy implements com.aixu.meeting.oa.workflow.WorkflowServicePortType {
  private String _endpoint = null;
  private com.aixu.meeting.oa.workflow.WorkflowServicePortType workflowServicePortType = null;
  ...
  private void _initWorkflowServicePortTypeProxy() {
    try {
      workflowServicePortType = (new com.aixu.meeting.oa.workflow.WorkflowServiceLocator()).getWorkflowServiceHttpPort();
  ...
  public com.aixu.meeting.oa.workflow.WorkflowServicePortType getWorkflowServicePortType() {
    if (workflowServicePortType == null)
      _initWorkflowServicePortTypeProxy();
