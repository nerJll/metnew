...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements com.aixu.meeting.oa.workflow.WorkflowService {
    ...
    public com.aixu.meeting.oa.workflow.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.aixu.meeting.oa.workflow.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.aixu.meeting.oa.workflow.WorkflowServiceHttpBindingStub _stub = new com.aixu.meeting.oa.workflow.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.aixu.meeting.oa.workflow.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.aixu.meeting.oa.workflow.WorkflowServiceHttpBindingStub _stub = new com.aixu.meeting.oa.workflow.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
