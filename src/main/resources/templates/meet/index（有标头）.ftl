	...
	$(function() {
		...
		if( window.outerHeight === screen.availHeight){
		    if(window.outerWidth === screen.availWidth){
		    	...
		    	console.log('非全屏')
		    	$.messager.alert('消息提示','为了数据有效性以及优化体验，请保持窗口最大化！')
		    }
		}else{
			console.log('非全屏')
			$.messager.alert('消息提示','为了数据有效性以及优化体验，请保持窗口最大化')
		...
		if(!!window.ActiveXObject || "ActiveXObject" in window){
			$.messager.alert("提示消息","不建议试用 IE 浏览器或兼容 IE 模式浏览本站！！")
		}
...
<body class="easyui-layout,fit:true">
	...
	<div class="easyui-layout,fit:true" style="width: 100%; height: 680px;">
		...
		<div data-options="region:'center'">
			<!-- 查询栏 -->
			<div style=" padding-top:10px;padding-bottom:10px;width: 100%; height: 10%; background-color: #006666;">
				<a href='${ctx}/meet/index' style='text-decoration: none;'>
				<span style='font-size: 20px; color: white; font-weight: bold;'>
				&nbsp;&nbsp;&nbsp;爱旭 - 会议室预订系统</span></a>
				<span style='float:right;'><a style="width: 90px; height: 30px; 
							font-size: 20px; color: white; font-weight: bold;"
							id='ApplyRode' onclick="applyFlow()" class="easyui-linkbutton"
							data-options="plain:true">预订流程</a>&nbsp;&nbsp;&nbsp;</span>
				<span style='float:right;'><a style="width: 90px; height: 30px; 
					font-size: 20px; color: white; font-weight: bold;"
						id='myApp' onclick="myApplyMeet()" class="easyui-linkbutton"
						data-options="iconCls:'icon-ok',plain:true" target="_blank">我的申请</a>&nbsp;&nbsp;&nbsp;</span>
			</div>
			<div style="margin-left:7%;width: 86%; height: 7%; background-color: #FAFAFA;">
				<table>
					<tr>
						<td width="180"></td>
						<td><span style="font-size: 15px; font-weight:bold; color: #006666;">会议日期：</span></td>
						<td><input class="easyui-datebox" id="metdate" value=""
							data-options="editable:false" style="width: 100px; height: 30px;"></td>
						<td><span style="font-size: 15px; font-weight:bold; color: #006666;">&nbsp;&nbsp;时间段：</span></td>
						...
						<td><span style="font-size: 15px; font-weight:bold; color: #006666;">至</span></td>
						<td><select style="width: 70px; height: 30px"
							data-options="editable:false,panelHeight:250"
						...
						<td><span style="font-size: 15px; font-weight:bold; color: #006666;">&nbsp;&nbsp;视频会议：</span></td>
						<td><input style="width: 18px; height: 18px" type="radio"
							id="audiomeet" name="audiomeet" value="视频会议"> <span
							style="font-size: 15px; font-weight:bold; color: #006666;">是</span></td>
						<td><input style="width: 18px; height: 18px" type="radio"
							id="audiomeet" name="audiomeet" value="普通会议"> <span
							style="font-size: 15px; font-weight:bold; color: #006666;">否</span></td>
						<td width="25"></td>
						<td><a href="javascript:void(0)" class="easyui-linkbutton"
							data-options="iconCls:'icon-search',plain:true" id="queryRoom"
							style="width: 80px; height: 30px; font-weight:bold; color: #006666;"
							onclick="queryRoom()">查询</a></td>
						<td><a style="width: 80px; height: 30px; font-weight:bold; color: #006666;"
							id="appMeet" onclick="applyMeet()" class="easyui-linkbutton"
							data-options="iconCls:'icon-add',plain:true">提交</a></td>
					</tr>
				</table>
			</div>
			<!-- 会议室信息栏 -->
			<div
				style="width: 86%; height: 83%; align: center; position: absolute; left: 7%;">
				<!-- 左 -->
				<div
					style="width: 84%; height: 100%; float: left; background-color: #FFFFFF;">
					<!-- 左-左 -->
					<div
						...
						<div
							...
							<table style="width: 100%; text-align: center; font-size: 20px">
								<tr>
									<td style='color: #006666; font-weight: bold' colspan="3">广东爱旭</td>
								</tr>
								...
								<tr>
									<td colspan="2">
										<div id="aiko_1"
											style="width: 230px; height: 170px; background-color: #006666; border-radius: 20px;">
											<table
									...
									<td>
										<div id="aiko_2"
											style="width: 180px; height: 170px; background-color: #006666; border-radius: 15px;">
											<table
								...
								<tr>
									<td colspan="2">
										<div id="aiko_4"
											style="width: 230px; height: 140px; background-color: #006666; border-radius: 15px;">
											<table
												style="width: 100%; text-align: center; font-size: 30px">
												<tr height=30px></tr>
												<tr>
									...
									<td>
										<div id="aiko_3"
											style="width: 180px; height: 140px; background-color: #006666; border-radius: 15px;">
											<table
												style="width: 100%; text-align: center; font-size: 30px">
								...
								<tr>
									<td colspan="2">
										<div id="aiko_11"
											style="width: 230px; height: 150px; background-color: #006666; border-radius: 20px;">
											<table
												...
												<tr>
													<td style="color: white" colspan="2"><b>陈总办公室</b></td>
												</tr>
												<tr>
													<td>
														<div id="aiko_11a">
									...
									<td>
										<div id="aiko_12"
											style="width: 180px; height: 150px; background-color: #006666; border-radius: 15px;">
											<table
												style="width: 100%; text-align: center; font-size: 25px">
												<tr style="height: 30px">
												</tr>
													...
													<td>
														<div id="aiko_12a">
															<div id="aiko_12b" style="float: left">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-search',plain:true"
																	style="width: 85px; height: 75px" id='queroom12'
																	onclick="getRoomInfo('aiko_12')"></a>
															</div>
															<div id="aiko_12c" style="float: right">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-ok',plain:true"
																	style="width: 85px; height: 75px" id='selectroom12'
														...
														<div id="aiko_12d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 85px; height: 75px" id='disecroom12'
					...
					<!-- 左-右 -->
					<div
						style="width: 56%; height: 100%; float: right; background-color: #FFFFFF;">
						<div
							style="width: 100%; height: 35px; background-color: #FFFFFF; margin: 3px 0 0 0">
							<table style="width: 100%; text-align: center; font-size: 20px">
								<tr>
									<td style='color: #006666; font-weight: bold' colspan="4">浙江爱旭</td>
								</tr>
								<tr style="height: 5px"></tr>
								<!-- 一排 -->
								<tr>
									...
									<td>
										<div id="aixu_1"
											style="width: 240px; height: 170px; background-color: #006666; border-radius: 20px;">
											<table
												style="width: 100%; text-align: center; font-size: 35px">
												<tr style="height: 40px">
													<td colspan="2"><img alt="视频会议"
				...
				<div
					...
					<div
						...
						<table style="width: 100%; text-align: center; font-size: 20px">
							<tr>
								<td style='color: #006666; font-weight: bold'>虚拟端口</td>
							</tr>
							<tr style="height: 5px"></tr>
							<!-- 一排 -->
							<tr>
								<td>
									<div id="dk_1"
										style="width: 180px; height: 48px; background-color: #006666; border-radius: 15px;">
										<table
