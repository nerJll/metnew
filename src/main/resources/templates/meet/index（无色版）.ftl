		...
		<div data-options="region:'center',title:'会议室预订',iconCls:'icon-tip'">
			...
			<div style="width: 100%; height: 95%">
				...
				<div style="width: 85%; height: 100%; float: left; background-color: #FAFAFA;">
						...
						<div
							...
							<table style="width: 100%; text-align: center; font-size: 20px">
								...
								<tr>
									<td colspan="2">
										<div id="aiko_1"
											style="width: 250px; height: 250px; background-color: #006666; border-radius: 8px;">
											<table
												style="width: 100%; text-align: center; font-size: 40px">
												<tr style="height: 40px">
													<td colspan="2"><img alt="视频会议"
														src="${ctx}/images/camera6.png" width=40px height=40px>
													</td>
												</tr>
												<tr>
													...
													<td>
														...
														<div id="aiko_1d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 120px; height: 120px	" id='disecroom1'
									...
									<td>
										<div id="aiko_2"
											style="width: 170px; height: 150px; background-color: #006666; border-radius: 8px;">
											<table
													...
													<td>
														<div id="aiko_2a">
															<div id="aiko_2b" style="float: left">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-search',plain:true"
																	style="width: 80px; height: 65px" id='queroom2'
																	onclick="getRoomInfo('aiko_2')"></a>
															</div>
															<div id="aiko_2c" style="float: right">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-ok',plain:true"
																	style="width: 80px; height: 65px" id='selectroom2'
														...
														<div id="aiko_2d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 80px; height: 65px" id='disecroom2'
								...
								<tr>
									<td colspan="2">
										<div id="aiko_3"
											style="width: 250px; height: 150px; background-color: #006666; border-radius: 8px;">
											<table
												style="width: 100%; text-align: center; font-size: 30px">
													...
													<td>
														<div id="aiko_3a">
															<div id="aiko_3b" style="float: left">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-search',plain:true"
																	style="width: 120px; height: 55px" id='queroom3'
																	onclick="getRoomInfo('aiko_3')"></a>
															</div>
															<div id="aiko_3c" style="float: right">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-ok',plain:true"
																	style="width: 120px; height: 55px" id='selectroom3'
														...
														<div id="aiko_3d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 120px; height: 55px" id='disecroom3'
									...
									<td>
										<div id="aiko_4"
											style="width: 170px; height: 200px; background-color: #006666; border-radius: 8px;">
											<table
												style="width: 100%; text-align: center; font-size: 30px">
													...
													<td>
														<div id="aiko_4a">
															<div id="aiko_4b" style="float: left">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-search',plain:true"
																	style="width: 80px; height: 105px" id='queroom4'
																	onclick="getRoomInfo('aiko_4')"></a>
															</div>
															<div id="aiko_4c" style="float: right">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-ok',plain:true"
																	style="width: 80px; height: 105px" id='selectroom4'
														...
														<div id="aiko_4d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 80px; height: 105px" id='disecroom4'
					...
					<!-- 左-右 -->
					<div style="width: 58%; height: 100%; float: right;background-color: #FAFAFA;">
						<div
							style="width: 100%; height: 35px; background-color: #FAFAFA; margin: 3px 0 0 0">
							<table style="width: 100%; text-align: center; font-size: 20px">
								<tr>
								...
								<tr>
									...
									<td>
										<div id="aixu_1"
											style="width: 290px; height: 250px; background-color: #006666; border-radius: 8px;">
											<table
												style="width: 100%; text-align: center; font-size: 40px">
												<tr style="height: 40px">
													<td colspan="2"><img alt="视频会议"
													...
													<td>
														<div id="aixu_1a">
															<div id="aixu_1b" style="float: left">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-search',plain:true"
																	style="width: 130px; height: 123px" id='queroom13'
																	onclick="getRoomInfo('aixu_1')"></a>
															</div>
															<div id="aixu_1c" style="float: right">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-ok',plain:true"
																	style="width: 130px; height: 123px" id='selectroom13'
														...
														<div id="aixu_1d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 130px; height: 123px" id='disecroom13'
													...
													<td>
														<div id="aixu_2a">
															<div id="aixu_2b" style="float: left">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-search',plain:true"
																	style="width: 130px; height: 123px" id='queroom14'
																	onclick="getRoomInfo('aixu_2')"></a>
															</div>
															<div id="aixu_2c" style="float: right">
																<a href="javascript:void(0)" class="easyui-linkbutton"
																	data-options="iconCls:'icon-ok',plain:true"
																	style="width: 130px; height: 123px" id='selectroom14'
														...
														<div id="aixu_2d" style="float: right">
															<a href="javascript:void(0)" class="easyui-linkbutton"
																data-options="iconCls:'icon-ok',plain:true"
																style="width: 130px; height: 123px" id='disecroom14'
