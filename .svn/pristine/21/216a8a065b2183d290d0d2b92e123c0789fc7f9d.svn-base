...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private com.aixu.meeting.oa.workflow.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
    		com.aixu.meeting.oa.workflow.WorkflowRequestTableRecord[] requestRecords,
     ...
     */
    public com.aixu.meeting.oa.workflow.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(com.aixu.meeting.oa.workflow.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
