...
public class WorkflowRequestTableRecord  implements java.io.Serializable {
    ...
    private com.aixu.meeting.oa.workflow.WorkflowRequestTableField[] workflowRequestTableFields;
    ...
    public WorkflowRequestTableRecord(
           ...
           com.aixu.meeting.oa.workflow.WorkflowRequestTableField[] workflowRequestTableFields) {
     ...
     */
    public com.aixu.meeting.oa.workflow.WorkflowRequestTableField[] getWorkflowRequestTableFields() {
        return workflowRequestTableFields;
    }
     ...
     */
    public void setWorkflowRequestTableFields(com.aixu.meeting.oa.workflow.WorkflowRequestTableField[] workflowRequestTableFields) {
        this.workflowRequestTableFields = workflowRequestTableFields;
    }
